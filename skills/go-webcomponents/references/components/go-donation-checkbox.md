...
## Related: `<go-donation-checkbox>`

For a lightweight fixed-amount opt-in — a single checkbox that adds/removes one
donation and syncs live with the cart, no navigation — see the _Donation
Checkbox Component_ documentation.
