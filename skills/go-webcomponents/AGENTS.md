...
These are tool-agnostic Markdown docs for integrating the gomus museum-ticketing web components (`<go-*>` custom elements) into any HTML page. Library version 4.12.0 (npm: `@gomusdev/web-components`).
